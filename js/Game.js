class Game {
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 130, height - player.positionY - 325, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 325, 185, 20);
    fill("#f50057");
    rect(width / 2 - 100, height - player.positionY - 325, player.life, 20);
    noStroke();
    pop();
  }
  ...
  showRank() {
    swal({
      title: `Awesome!${"\n"}Rank${"\n"}${player.rank}`,
      text: "You successfully reached the finish line",
      imageUrl:
